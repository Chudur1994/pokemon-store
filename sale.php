...
if (isset($_POST['salePokemon'])) {
  ...
  $output .= "<div class='card-panel z-depth-2' style='$style'>
                ...
                <p>{$pokemon[0]->getDescription()} Lorem ipsum dolor sit amet, consectetur adipisicing elit. Adipisci dignissimos eligendi illo, in praesentium totam!</p>
                <h6>Learned Moves</h6>
                <ul>
                  <li>&bull; move1</li>
                  <li>&bull; move2</li>
                ...
                <a style='width: 100%;' class='btn green waves-effect waves-light'>
